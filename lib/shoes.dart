...
class ShoesState extends State<Shoes> {
  @override
                  ...
                  Positioned(
                    ...
                    child: FadeInUp(duration: const Duration(milliseconds: 1000), child: Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          FadeInUp(duration: const Duration(milliseconds: 1300), child: const Text("Sneakers", style: TextStyle(color: Colors.white, fontSize: 50, fontWeight: FontWeight.bold),)),
                          const SizedBox(height: 25,),
                          FadeInUp(duration: const Duration(milliseconds: 1400), child: const Text("Size", style: TextStyle(color: Colors.white, fontSize: 20),)),
                          const SizedBox(height: 10,),
                          Row(
                            children: <Widget>[
                              FadeInUp(duration: const Duration(milliseconds: 1450), child: Container(
                                width: 40,
                                height: 40,
                              ...
                              FadeInUp(duration: const Duration(milliseconds: 1460), child: Container(
                                width: 40,
                                height: 40,
                                margin: const EdgeInsets.only(right: 20),
                                child: const Center(
                              ...
                              FadeInUp(duration: const Duration(milliseconds: 1470), child: Container(
                                width: 40,
                                height: 40,
                                margin: const EdgeInsets.only(right: 20),
                                child: const Center(
